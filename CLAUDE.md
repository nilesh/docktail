...
Docktail is a TUI application for monitoring Docker container logs. It targets developers running multi-container Docker Compose setups who need a better alternative to `docker compose logs -f`.
...
internal/ui/         — UI components (planned, currently in app.go)
```
